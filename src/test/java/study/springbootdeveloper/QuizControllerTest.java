...
class QuizControllerTest {
    ...
    @DisplayName("quiz(): GET /quiz?code=1 이면 응답 코드는 201, 본문은 Created!를 리턴한다.")
    @Test
    ...
    @DisplayName("quiz(): GET /quiz?code=2 면 응답 코드는 400, 응답 본문은 bad Request! 리턴한다")
    @Test
    ...
    @Test
    public void postQuiz4() throws Exception {
        //given
        final String url = "/quiz";
